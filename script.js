$(document).ready(function() {
  ...
  function searchOpenWeather(inputCity) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/weather?q=" + inputCity + "&appid=779f16fce6ffa8c704fece84b9e27a29&units=imperial",
      dataType: "json",
  ...
  function getForecast(inputCity) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/forecast?q=" + inputCity + "&appid=779f16fce6ffa8c704fece84b9e27a29&units=imperial",
      dataType: "json",
      success: function(data) {
  ...
  function getUVIndex(lat, lon) {
    $.ajax({
      type: "GET",
      url: "http://api.openweathermap.org/data/2.5/uvi?appid=779f16fce6ffa8c704fece84b9e27a29&lat=" + lat + "&lon=" + lon,
      dataType: "json",
      success: function(data) {
